  ...
  render() {
    return (
      <View>
        ...
        <Button
          onPress={() => this.sub(this.state.valor1, this.state.valor2, this.state.resultado)}
          title="Subtrair"
        />

        <Button
          onPress={() => this.mult(this.state.valor1, this.state.valor2, this.state.resultado)}
          title="Multiplicar"
        />

        <Button
          onPress={() => this.div(this.state.valor1, this.state.valor2, this.state.resultado)}
          title="Dividir"
        />
      </View>
    )
